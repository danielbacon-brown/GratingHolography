       ...
       function L = IncidentLightGeneral(options)
            ...
            if L.normalIncidence
                ...
                elseif strcmp(options.lattice,'hexagonal')
                    ...
                    L.theta = 0;
                elseif strcmp(options.lattice,'rectangle')
                    phi_interference = asin( 1/( options.C*sqrt(1/options.A^2+1/options.B^2+1/options.C^2)));
                    L.theta = atan( options.periodX/options.periodY);
                end
                ...
                L.phi = phi_glass*180/pi; %S4 wants angles in degrees
            ...
            elseif strcmp(options.lattice,'rectangular')
                unitCellArea = options.periodX*options.periodY*1e-12; %m^2
