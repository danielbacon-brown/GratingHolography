classdef S4interfaceSquareReflect
    %Writes a script for creating a square grating and illumination conditions in S4
    %The grating is a reflection grating, assuming a metallic coating on a dielectric mask
    ...
    methods
        ...
        function S = S4interfaceSquareReflect(dimensions,cells,metal_name,thickness_metal, isAirGap,n_interference)
            
            S.isAirGap = isAirGap;
            S.n_interference = n_interference;
            
            S.cells = cells;
            S.thickness_metal = thickness_metal;
            switch metal_name
                case 'silver'
            ...
            periodX = dimensions(1);
            periodY = dimensions(2);
            ...
            %For reflection mask, the order from front is: glass, thick SU8,
            %air (can assume there will be a small air gap), air and silver grating,air and SU8 grating, silver and SU8
            %grating, SU8 (assuming doing nanoimprints), and finally glass
            if S.isAirGap==1
                S.setFrontLayersScript = [ ...
                    'S:AddLayer(''Front'', 0, ''Glass'')  \r\n' ...
                    , 'S:AddLayer(''PrInterference'', 5, ''SU8'')  -- thick SU8 layer \r\n' ...
                    , 'S:AddLayer(''AirGap'', 5, ''Vacuum'')  \r\n' ... %air gap
                    ];
            else
                S.setFrontLayersScript = [ ...
                    'S:AddLayer(''Front'', 0, ''Glass'')  \r\n' ...
                    , 'S:AddLayer(''ITOLayer'',0.1, ''SU8'') \r\n' ...
                    , 'S:AddLayer(''PrInterference'', 5, ''SU8'')  -- thick SU8 layer \r\n' ...
                    ];
            end
            S.setBackLayersScript = [ ...
                'S:AddLayer(''SU8afterGrating'',3,''SU8'')  \r\n' ...
...
delete([scriptFilename]);
        ...
        function makeRunScript(S,GAoptions,grating,incidentFieldParams,dataFilename,scriptFilename)
            ...
            if S.isAirGap==1
                setLayersScript = [ ...
                    sprintf('S:AddLayer(''MetalAirGrating'', %1.6f, ''Vacuum'')  --first grating layer \r\n', S.thickness_metal) ...
                    , sprintf('S:AddLayer(''SU8AirGrating'', %1.6f, ''Vacuum'')  --intermediate grating layer \r\n', strat.thick-S.thickness_metal) ...
                    , sprintf('S:AddLayer(''SU8MetalGrating'', %1.6f, ''Metal'')  --bottom grating layer \r\n', S.thickness_metal )];
            else
                setLayersScript = [ ...
                    sprintf('S:AddLayer(''MetalSU8Grating'', %1.6f, ''SU8'')  --first grating layer \r\n', S.thickness_metal) ...
                    , sprintf('S:AddLayer(''SU8SU8Grating'', %1.6f, ''SU8'')  --intermediate grating layer \r\n', strat.thick-S.thickness_metal) ...
                    , sprintf('S:AddLayer(''SU8MetalGrating'', %1.6f, ''Metal'')  --bottom grating layer \r\n', S.thickness_metal )];
            end
            ...
            for s = 1:length(strat.stripe)
                stripe = strat.stripe{1,s};
                stripeEnd = stripe.c1;
                lastX = 0; %marks the position of the end of the last block
                for b = 1:length( stripe.block )
                    blockEnd = stripe.block{1,b}.c2;
                    if stripe.block{1,b}.pmt_index == 2 %if it's marked as SU8
                        ...
                        if S.isAirGap==1
                            setLayersScript = [setLayersScript, sprintf('S:SetLayerPatternRectangle(''MetalAirGrating'', ''Metal'', {%1.7f,%1.7f}, 0, {%1.7f,%1.7f}) \r\n',centerX,centerY,widthX/2,widthY/2)];
                            setLayersScript = [setLayersScript, sprintf('S:SetLayerPatternRectangle(''SU8AirGrating'', ''SU8'', {%1.7f,%1.7f}, 0, {%1.7f,%1.7f}) \r\n',centerX,centerY,widthX/2,widthY/2)];
                            setLayersScript = [setLayersScript, sprintf('S:SetLayerPatternRectangle(''SU8MetalGrating'', ''Vacuum'', {%1.7f,%1.7f}, 0, {%1.7f,%1.7f}) \r\n',centerX,centerY,widthX/2,widthY/2)];
                        else
                            setLayersScript = [setLayersScript, sprintf('S:SetLayerPatternRectangle(''MetalSU8Grating'', ''Metal'', {%1.7f,%1.7f}, 0, {%1.7f,%1.7f}) \r\n',centerX,centerY,widthX/2,widthY/2)];
                            setLayersScript = [setLayersScript, sprintf('S:SetLayerPatternRectangle(''SU8MetalGrating'', ''Vacuum'', {%1.7f,%1.7f}, 0, {%1.7f,%1.7f}) \r\n',centerX,centerY,widthX/2,widthY/2)];
                        end
