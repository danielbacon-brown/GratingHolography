...
GAoptions.hostname = strtrim(hostname);
    ...
    elseif strcmp(strtrim(hostname),'DESKTOP-5RVEK1H')
        GAoptions.dir = ['C:/Users/daniel/GA_squareGyroid/','GA_ver2_externalBeams_',datestr(now,'mm-dd-yy_HH;MM'),'_N',int2str(GAoptions.popSize), '/']  %directory that all this goes into
    end
    ...
    S4interfaceOptions.materials(7) = Material('BK7glass',GAoptions.n_BK7glass);
...
%     S4interfaceOptions.layers(5) = Layer('Back','Vacuum', 0);
    ...
    S4interfaceOptions.layers(1) = Layer('Front','BK7glass',0);
...
%For  GratingGrid
    ...
    targetStructureOptions.structureType = 'gyroid';
    ...
    elseif strcmp(targetStructureOptions.structureType, 'gyroid')
        GAoptions.targetStructure = generateGyroid(GAoptions.cells,0.5);
    end
...
fillOptions.constFill = 0.5;
fillOptions.chromNfill = 0;
