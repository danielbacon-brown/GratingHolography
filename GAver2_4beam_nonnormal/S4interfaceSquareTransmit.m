classdef S4interfaceSquareTransmit
    ...
    methods
        ...
        function S = S4interfaceSquareTransmit(options) %.dimensions,cells,metal_name,thickness_metal, isAirGap,n_interference)
...
%             end
            ...
            %For Transmission grating, order is: glass/PDMS? prism, SU8 and air
            %grating, SU8 (interference), ITO, glass
